...
user_info = Data.user_input()
login_pass = user_info[0]
user_name = user_info[1]

lesson = Data.lesson_input()
...
username_field.send_keys(login_pass["login"])
password_field.send_keys(login_pass["password"])
login_field.click()

driver.get(url=lesson)
